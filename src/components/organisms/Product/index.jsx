...
const Product =()=> {
    ...
    return(
        <section className='mt-20'>
            <div className='grid grid-cols-[2fr_1.5fr_1fr] items-center container gap-6 mb-20'>
                ...
                <div className='text-center'>
                    <button onClick={()=> handleScrollClick('left') } className='rounded-full mx-2 bg-gray-300 p-2'><ArrowLeftIcon className='w-5 h-5 text-white'/></button>
                    <button onClick={()=> handleScrollClick('right') }  className='rounded-full mx-2 bg-blue-primary p-2'><ArrowRightIcon  className='w-5 h-5 text-white hover:shadow-blue-primary'/></button>
                </div>
            </div>
